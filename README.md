...
- 🚀 **Mobile Maven**: Flutter and Dart specialist from more than 2 years.
- 📱 **Backstage Sorcery**: SQL, MySQL, SQFLite, Isar, and Restful APIs.
- 🌐 **Web Wizardry**: HTML, CSS, JavaScript (basic), and Bootstrap.
- 🚀 **VCS**: GitHub & GitLab.
- 💾 **Database Dynamo**: Firebase, and SQFLite.
- 🎨 **Design Connoisseur**: Figma for graphic design.
- 📱 **State Management**: Provider, Getx and Bloc/Cubit.
- 🚀 **Others**: Unit Tests, Widget Tests, CI/CD & SDKs Integration.

## 🔥 Published Apps Made

- [Ai Logo Maker: Design Studio](https://apps.apple.com/pk/app/ai-logo-maker-design-studio/id6747566522)
- [Botai: Ai Plant Identifier](https://apps.apple.com/us/app/botai-ai-plant-identifier/id6754072311) 
- [PowevateFitness](https://apps.apple.com/pk/app/powervatefitness/id6751278357)
